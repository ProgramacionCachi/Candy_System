				...
				<tbody>
					<?php foreach ($ventas as $venta) { ?>
						<tr>
							...
							<!--<td><a class="btn btn-info" href="<?php echo "eliminarVenta.php?id=" . $venta->id?>"><i class="fa fa-trash"></i></a></td>-->
							



							<td><a class="btn btn-info" href="<?php echo "Factura.php?id_facturar=" . $venta->id ?>"><i class="fa fa-edit"></i></a></td>
